...
\`\`\`json
{
  ...
  "emotionTags": ["逆袭", "打脸", "爽文", "甜宠", "复仇", "重生"],
  "genreTags": {
    "primary": "男频逆袭|女频甜宠|女频虐恋|男频玄幻|都市复仇",
    "secondary": ["标签1", "标签2"],
    "platformTags": ["红果推荐标签1", "标签2"]
  },
...
export const COMPLIANCE_ANALYSIS_PROMPT = `## 任务：AI漫剧合规与平台审核评估

请对以下AI漫剧剧本进行合规审查，**重点关注AI生成内容和短视频平台的特殊要求**：
...
5. **价值观导向**：短视频平台对价值观的严格要求
6. **未成年人保护**：短视频平台的特殊保护要求
...
\`\`\`json
{
  "compliance": {
    ...
    "issues": [
      {
        "location": "第X集/场",
        "type": "暴力|色情|政治|迷信|价值观|版权|AI生成|低俗",
  ...
  "valueOrientation": {
    ...
    "concerns": ["需关注点"],
    "moralClosure": "善恶有报的闭环是否完整",
    "score": 8.5
  },
  "ageRating": {
    "suggested": "全年龄|12+|16+|18+",
    "reason": "分级原因",
...
\`\`\`json
{
  ...
  "executiveSummary": {
    "genre": "男频|女频|中性",
    "subGenre": "逆袭|甜宠|虐恋|玄幻|都市|重生|穿越|职场",
